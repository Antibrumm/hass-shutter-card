  ...
  set hass(hass) {
    ...
    if (!this.card) {
      ...
      style.textContent = `
        ...
        .sc-shutter-buttons { color: var(--paper-item-icon-color); flex: 1; text-align: center; margin-top: 1.5rem; }
        ...
        .sc-shutter-position { color: var(--paper-item-icon-color); display: inline-block; vertical-align: middle; padding: 0px 6px; margin-left: 0.5rem; border-radius: 2px; }
      `;
